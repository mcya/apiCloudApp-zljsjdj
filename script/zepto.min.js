/*! Zepto 1.1.6 (generated with Zepto Builder) - zepto event touch selector - zeptojs.com/license */
var Zepto = function() {
	function t(t) {
	...
	function h(t) {
		var e, n;
		return $[t] || ( e = Z.createElement(t), Z.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && ( n = "block"), $[t] = n), $[t]
	}

	function p(t) {
		return "children" in t ? L.call(t.children) : N.map(t.childNodes, function(t) {
	...
	function g(t, e, n) {
		for (T in e)n && (o(e[T]) || Q(e[T])) ? (o(e[T]) && !o(t[T]) && (t[T] = {}), Q(e[T]) && !Q(t[T]) && (t[T] = []), g(t[T], e[T], n)) : e[T] !== x && (t[T] = e[T])
	}
	...
	var x, T, N, C, P, S, O = [], M = O.concat, A = O.filter, L = O.slice, Z = window.document, $ = {}, D = {}, k = {
		"column-count" : 1,
		columns : 1,
		"font-weight" : 1,
		"line-height" : 1,
		...
		"z-index" : 1,
		zoom : 1
	}, j = /^\s*<(\w+|!)[^>]*>/, q = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, z = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, R = /^(?:body|html)$/i, _ = /([A-Z])/g, I = ["val", "css", "html", "text", "data", "width", "height", "offset"], V = ["after", "prepend", "before", "append"], B = Z.createElement("table"), F = Z.createElement("tr"), U = {
		...
		th : F,
		"*" : Z.createElement("div")
	}, Y = /complete|loaded|interactive/, H = /^[\w-]*$/, X = {}, J = X.toString, G = {}, W = Z.createElement("div"), K = {
		tabindex : "tabIndex",
		readonly : "readOnly",
		"for" : "htmlFor",
		"class" : "className",
	...
	return G.matches = function(t, e) {
		...
		return o && ( r = W).appendChild(t), i = ~G.qsa(r, e).indexOf(t), o && W.removeChild(t), i
	}, P = function(t) {
		...
		var i, r, s;
		return q.test(t) && ( i = N(Z.createElement(RegExp.$1))), i || (t.replace && ( t = t.replace(z, "<$1></$2>")), e === x && ( e = j.test(t) && RegExp.$1), e in U || ( e = "*"), s = U[e], s.innerHTML = "" + t, i = N.each(L.call(s.childNodes), function() {
			s.removeChild(this)
		})), o(n) && ( r = N(i), N.each(n, function(t, e) {
		...
		return t.getElementById && s && i ? ( n = t.getElementById(o)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType && 11 !== t.nodeType ? [] : L.call(s && !i && t.getElementsByClassName ? r ? t.getElementsByClassName(o) : t.getElementsByTagName(e) : t.querySelectorAll(e))
	}, N.contains = Z.documentElement.contains ? function(t, e) {
		...
		for (; e && ( e = e.parentNode); )
			if (e === t)
				return !0;
		return !1
	}, N.type = t, N.isFunction = e, N.isWindow = n, N.isArray = Q, N.isPlainObject = o, N.isEmptyObject = function(t) {
		var e;
		for (e in t)
		return !1;
		return !0
		...
		concat : function() {
			...
			return M.apply(G.isZ(this) ? this.toArray() : this, n)
		},
		map : function(t) {
		...
		ready : function(t) {
			return Y.test(Z.readyState) && Z.body ? t(N) : Z.addEventListener("DOMContentLoaded", function() {
				t(N)
			}, !1), this
		},
		get : function(t) {
		...
		filter : function(t) {
			return e(t) ? this.not(this.not(t)) : N(A.call(this, function(e) {
		...
		not : function(t) {
			...
			if (e(t) && t.call !== x)
				...
				var i = "string" == typeof t ? this.filter(t) : s(t) && e(t.item) ? L.call(t) : N(t);
		...
		closest : function(t, e) {
			var n = this[0], r = !1;
			for ("object" == typeof t && ( r = N(t)); n && !( r ? r.indexOf(n) >= 0 : G.matches(n, t)); )
		...
		html : function(t) {
			return 0 in arguments ? this.each(function(e) {
				...
				N(this).empty().append(v(this, t, e, n))
		...
		data : function(t, e) {
			var n = "data-" + t.replace(_, "-$1").toLowerCase(), i = 1 in arguments ? this.attr(n, e) : this.attr(n);
			return null !== i ? b(i) : x
		},
		val : function(t) {
			return 0 in arguments ? this.each(function(e) {
		...
		offset : function(t) {
			if (t)
				return this.each(function(e) {
					var n = N(this), i = v(this, t, e, n.offset()), r = n.offsetParent().offset(), o = {
						top : i.top - r.top,
						left : i.left - r.left
					};
			...
			if (!this.length)
				return null;
			if (!N.contains(Z.documentElement, this[0]))
				return {
					top : 0,
					left : 0
				};
		...
		css : function(e, n) {
			if (arguments.length < 2) {
				...
				if ( i = getComputedStyle(r, ""), "string" == typeof e)
					return r.style[P(e)] || i.getPropertyValue(e);
				if (Q(e)) {
					var o = {};
		...
		toggleClass : function(t, e) {
			return t ? this.each(function(n) {
				var i = N(this), r = v(this, t, n, w(this));
		...
		offsetParent : function() {
			return this.map(function() {
				for (var t = this.offsetParent || Z.body; t && !R.test(t.nodeName) && "static" == N(t).css("position"); )
					t = t.offsetParent;
				return t
			})
		}
		...
		N.fn[t] = function(r) {
			var o, s = this[0];
			return r === x ? n(s) ? s["inner" + e] : i(s) ? s.documentElement["scroll" + e] : ( o = this.offset()) && o[t] : this.each(function(e) {
		...
		N.fn[e] = function() {
			...
			return o.length < 1 ? this : this.each(function(t, e) {
				...
				var u = N.contains(Z.documentElement, r);
				o.forEach(function(t) {
					if (s)
						t = t.cloneNode(!0);
					else if (!r)
						return N(t).remove();
					r.insertBefore(t, e), u && E(t, function(t) {
	...
	}), G.Z.prototype = d.prototype = N.fn, G.uniq = S, G.deserializeValue = b, N.zepto = G, N
}();
window.Zepto = Zepto,
void 0 === window.$ && (window.$ = Zepto), function(t) {
	...
	function n(t, n, o, s) {
		...
		return (m[e(t)] || []).filter(function(t) {
			return t && (!n.e || t.e == n.e) && (!n.ns || u.test(t.ns)) && (!o || e(t.fn) === e(o)) && (!s || t.sel == s)
		})
	}
	...
	function u(n, r, u, a, l, h, p) {
		var d = e(n), g = m[d] || (m[d] = []);
		r.split(/\s/).forEach(function(e) {
			if ("ready" == e)
				return t(document).ready(u);
			var r = i(e);
			r.fn = u, r.sel = l, r.e in b && ( u = function(e) {
				var n = e.relatedTarget;
				return !n || n !== this && !t.contains(this, n) ? r.fn.apply(this, arguments) :
				void 0
			}), r.del = h;
			var d = h || u;
			r.proxy = function(t) {
			...
			}, r.i = g.length, g.push(r), "addEventListener" in n && n.addEventListener(s(r.e), r.proxy, o(r, p))
		})
	}
	...
	function a(t, i, r, u, a) {
		...
		(i || "").split(/\s/).forEach(function(e) {
			n(t, e, r, u).forEach(function(e) {
				delete m[c][e.i], "removeEventListener" in t && t.removeEventListener(s(e.e), e.proxy, o(e, a))
			})
		})
	}

	function c(e, n) {
		return (n || !e.isDefaultPrevented) && (n || ( n = e), t.each(N, function(t, i) {
			var r = n[t];
			e[t] = function() {
	...
	var f, h = 1, p = Array.prototype.slice, d = t.isFunction, g = function(t) {
	...
	t.fn.delegate = function(t, e, n) {
		...
		return e && !g(e) ? (t.each(e, function(t, e) {
			h.on(t, n, i, e, o)
		}), h) : (g(n) || d(r) || r === !1 || ( r = i, i = n, n = f), (r === f || i === !1) && ( r = i, i = f), r === !1 && ( r = x), h.each(function(f, h) {
			o && ( s = function(t) {
		...
		return e && !g(e) ? (t.each(e, function(t, e) {
			r.off(t, n, e)
		}), r) : (g(n) || d(i) || i === !1 || ( i = n, n = f), i === !1 && ( i = x), r.each(function() {
			a(this, e, i, n)
		}))
		...
		return this.each(function(s, u) {
			r = l(g(e) ? t.Event(e) : e), r._args = i, r.target = u, t.each(n(u, e.type || e), function(t, e) {
				return o = e.proxy(r), r.isImmediatePropagationStopped() ? !1 :
				void 0
			})
		}), o
	...
	var i = t.zepto, r = i.qsa, o = i.matches, s = t.expr[":"] = {
		visible : function() {
			return e(this) ? this :
			void 0
		},
		...
		contains : function(e, n, i) {
			return t(this).text().indexOf(i) > -1 ? this :
			void 0
		},
		has : function(t, e, n) {
			return i.qsa(this, n).length ? this :
			void 0
		}
	}, u = new RegExp("(.*):(\\w+)(?:\\(([^)]+)\\))?$\\s*"), a = /^\s*>/, c = "Zepto" + +new Date;
	i.qsa = function(e, o) {
		return n(o, function(n, s, u) {
			try {
				var l;
				!n && s ? n = "*" : a.test(n) && ( l = t(e).addClass(c), n = "." + c + " " + n);
				var f = r(e, n)
			} catch(h) {
	...
	function r() {
		u && clearTimeout(u), a && clearTimeout(a), c && clearTimeout(c), l && clearTimeout(l), u = a = c = l = null, h = {}
	}
	...
	t(document).ready(function() {
		...
		"MSGesture" in window && ( f = new MSGesture, f.target = document.body), t(document).bind("MSGestureEnd", function(t) {
			...
			(!( v = s(e, "down")) || o(e)) && ( m = v ? e : e.touches[0], e.touches && 1 === e.touches.length && h.x2 && (h.x2 =
			void 0, h.y2 =
			void 0), d = Date.now(), g = d - (h.last || d), h.el = t("tagName" in m.target ? m.target : m.target.parentNode), u && clearTimeout(u), h.x1 = m.pageX, h.y1 = m.pageY, g > 0 && 250 >= g && (h.isDoubleTap = !0), h.last = d, l = setTimeout(n, p), f && v && f.addPointer(e.pointerId))
		}).on("touchmove MSPointerMove pointermove", function(t) {
			(!( v = s(t, "move")) || o(t)) && ( m = v ? t : t.touches[0], i(), h.x2 = m.pageX, h.y2 = m.pageY, y += Math.abs(h.x1 - h.x2), w += Math.abs(h.y1 - h.y2))
			...
			}, 0) : "last" in h && (30 > y && 30 > w ? a = setTimeout(function() {
				var e = t.Event("tap");
				e.cancelTouch = r, h.el.trigger(e), h.isDoubleTap ? (h.el && h.el.trigger("doubleTap"), h = {}) : u = setTimeout(function() {
